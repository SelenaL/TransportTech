...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 08, 2015 at 06:31 PM
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `username` varchar(15) COLLATE utf8mb4_estonian_ci NOT NULL,
  `password` varchar(15) COLLATE utf8mb4_estonian_ci NOT NULL,
